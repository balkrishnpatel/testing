...
describe('index.html', () => {
  ...
  it('renders a heading element', () => {
    ...
    expect(getByText(container, 'Balkrishna')).toBeInTheDocument()
  })
  ...
  it('check whether of out of puns', () => {
    const button = getByText(container, 'Click me for a terrible pun')
    fireEvent.click(button)
    fireEvent.click(button)
    fireEvent.click(button)
    ...
    fireEvent.click(button)
    fireEvent.click(button)
    expect(getByText(container, "I'm all out of puns!")).toBeInTheDocument()
  })
